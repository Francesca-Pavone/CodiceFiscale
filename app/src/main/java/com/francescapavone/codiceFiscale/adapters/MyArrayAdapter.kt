package com.francescapavone.codiceFiscale.adapters
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun performFiltering(charSequence: CharSequence?): Filter.FilterResults {
                val queryString = charSequence?.toString()?.uppercase(Locale.getDefault())
                ...
                filterResults.values = if (queryString == null || queryString.isEmpty())
                    ...
                    allPlacesList.filter {
                        it.description.uppercase(Locale.getDefault()).startsWith(queryString)
                    }
