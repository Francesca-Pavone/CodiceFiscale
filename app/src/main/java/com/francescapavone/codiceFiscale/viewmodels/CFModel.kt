...
class CFModel {
    companion object {
        ...
        fun encode(
            ...
            val first15 = getLastNameCode(lastName) +
                    getFirstNameCode(firstName) +
                    getBirthAndSexCode(birthDate, gender) +
                    getCountryCode(birthPlace)
            return first15 +
                    getControlCode(first15)
        }

        private fun getBirthAndSexCode(birthDate: String, gender: String): String {
            var ret = "99X99"
        ...
        private fun getFirstNameCode(firstName: String): String {
            var vowels = ""
            var consonants = ""
        ...
        private fun getLastNameCode(lastName: String): String {
            var consonants = ""
            var vowels = ""
        ...
        private fun getCountryCode(birthPlace: String): String {
            var ret = birthPlace
            if (ret == "")
                ret = "X999"
            return ret
